...
//				.anyRequest();
		...
		.antMatchers("/vendor").permitAll().antMatchers("/vendor/**").permitAll()
		.antMatchers("/bill").permitAll().antMatchers("/bill/**").permitAll()
		.antMatchers("/menu-items").permitAll()
		.antMatchers("/authenticate").hasAnyRole("USER", "ADMIN","VENDOR").anyRequest().authenticated()
